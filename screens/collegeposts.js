...
export class CollegePosts extends React.Component {
  static navigationOptions = {
    tabBarLabel: 'مصارحات الكلية',
    tabBarIcon : ({tintColor})=> ( <FontAwesome style={{fontSize : 20 , marginTop : 5  , color : tintColor }} name='university' /> ),
    ...
    constructor(props) {
      ...
      super(props)
       ...
       async componentWillMount() {
        ...
        fetch('https://sarihapp.herokuapp.com/api/collegeposts', {
            method: 'GET',
            headers: {
