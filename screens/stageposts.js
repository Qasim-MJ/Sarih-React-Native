...
import { Ionicons , FontAwesome , MaterialCommunityIcons , Foundation , Entypo } from '@expo/vector-icons';
...
export class StagePosts extends React.Component {
  static navigationOptions = {
    tabBarLabel: 'مصارحات المرحلة',
    tabBarIcon : ({tintColor})=> ( <Foundation style={{fontSize : 20 , marginTop : 5  , color : tintColor }} name='torsos-all' /> ),
    ...
    constructor(props) {
      ...
      super(props)
       ...
       async componentWillMount() {
        ...
        fetch('https://sarihapp.herokuapp.com/api/stageposts', {
            method: 'GET',
            headers: {
      ...
      <StatusBar
       ...
       />
          ...
          {renderIf(this.state.loadingDisplay ,
            <View style={{width : width , alignItems : 'center' , marginBottom : -40 }}>
            <Spinner color="gray" />
            </View>
          )}
...
const StagePostsNav = StackNavigator({
